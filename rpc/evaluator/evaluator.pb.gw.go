...
/*
Package evaluator is a reverse proxy.
...
func request_Evaluator_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, client EvaluatorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Evaluator_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, server EvaluatorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HelloRequest
	var metadata runtime.ServerMetadata
...
func RegisterEvaluatorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EvaluatorServer) error {
	...
	mux.Handle("POST", pattern_Evaluator_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/evaluator.Evaluator/SayHello", runtime.WithHTTPPathPattern("/rpc/evaluator/v1/say_hello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Evaluator_SayHello_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Evaluator_SayHello_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterEvaluatorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EvaluatorClient) error {
	...
	mux.Handle("POST", pattern_Evaluator_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/evaluator.Evaluator/SayHello", runtime.WithHTTPPathPattern("/rpc/evaluator/v1/say_hello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Evaluator_SayHello_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Evaluator_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"rpc", "evaluator", "v1", "say_hello"}, ""))
)

var (
	forward_Evaluator_SayHello_0 = runtime.ForwardResponseMessage
)
